...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "text-section-heading");
    			add_location(h2, file$3, 47, 4, 1630);
    			attr_dev(div, "class", "item-spacing");
    			add_location(div, file$3, 46, 2, 1598);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(46:0) {#if projects.length > 0}",
    		ctx
    	});
    ...
    function create_each_block$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:4) {#each projects as project}",
    		ctx
    	});
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let projects = [
    		...
    		},
    		{
    			...
    			liveDemoLink: null,
    			description: "A space-efficient Database Management System. Currently WIP, the repository may not be updated in a while."
    		},
    		{
    			name: "Ligh",
    			pageLink: null,
